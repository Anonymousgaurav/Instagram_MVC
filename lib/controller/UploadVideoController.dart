...
import 'package:insta_mvc_demo/models/UserVideoModel.dart';
...
class UploadVideoController extends GetxController {
  ...
  uploadVideo(String videoPath, String song, String caption) async {
    try {
      ...
      Video video = Video(
        ...
        likes: [],
        profilePic:
            (documentSnapshot.data()! as Map<String, dynamic>)['ProfilePic'],
        caption: caption,
        id: id,
      );
  ...
  Future<String> _uploadThumbToStorage(String id, String videoPath) async {
    Reference reference =
        FirebaseStorage.instance.ref().child('thumb').child(id);
